        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className='font-semibold text-lg'>
                    ...
                    <p>Com o ReachOut, você pode criar e divulgar seus anúncios de forma simples e eficiente, além de organizar e personalizar seus cardápios de maneira única.</p>
                </div>
