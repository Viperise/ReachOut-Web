import useEstablishment from '@app/app/hooks/establishments';
...
const TableEstablishment = () => {
  const { Items, page, pages, setPage } = useEstablishment();
              ...
              <TableCell>
                <div className="flex justify-center">
                  <Link href={`/establishments/${item.id}`}>
                    <button className="py-2 px-4 border rounded-full text-info-500">MAIS DETALHES</button>
                  </Link>
                </div>
              </TableCell>
            </TableRow>
